...
/*! @name PORTB0 (number 35), J4[12]/A5-I2C0_SCL/ADC0_SE8
  @{ */
#define BOARD_I2C0_SCL_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_I2C0_SCL_PIN 0U     /*!<@brief PORTB pin index: 0 */
                                  /* @} */

/*! @name PORTB1 (number 36), J4[10]/A4-I2C0_SDA/ADC0_SE9
  @{ */
#define BOARD_I2C0_SDA_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_I2C0_SDA_PIN 1U     /*!<@brief PORTB pin index: 1 */
                                  /* @} */
